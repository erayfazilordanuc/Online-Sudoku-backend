...
import sudoku.Authentication.filters.JWTAuthFilter;
import sudoku.User.services.UserService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/api/user", "/api/game", "/api/game/init", "/api/game/finish").authenticated()
